...
def partition_classes(X, y, split_attribute, split_val):
    ...
    #Split values based on string or not string
...
def information_gain(previous_y, current_y):
    ...
    total_info_gain = 0
    for vals in current_y:
        total_info_gain += len(vals)/float(len(previous_y)) * entropy(vals)

    info_gain = entropy(previous_y) - total_info_gain
